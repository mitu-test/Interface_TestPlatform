...
import unittest
import requests
from ExtentHTMLTestRunner1 import HTMLTestRunner
import time
...
class InterfaceTest(unittest.TestCase):
    @unpack
    @file_data(EXTEND_DIR + "test_data_list2.json")
...
if __name__ == '__main__':
    ...
    filePath = r'E:\Interface_TestPlatform\apps\apitest\templates\apitest\report1.html'
    fp = open(filePath, 'wb')
